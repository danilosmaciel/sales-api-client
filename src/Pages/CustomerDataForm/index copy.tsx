...
export const CustomerDataForm = () => {
    ...
    const loadCustomerInfo = async () => {
        ...
        if (data) {
            ...
            setValue("dateBirth", data.dateBirth);
            ...
            <div className="customers-form-data">
                ...
                <Box bg='' w='90%'  pl="5%" pt={5} color='black'>
                    ...
                    <form  onSubmit={e => e.preventDefault()} noValidate>
                                <Box>
                                    <FormControl id="fullname" isRequired isInvalid={ errors.fullName ? true: false }>
                                    ...
                                    <FormErrorMessage>O campo nome completo é requerido </FormErrorMessage>
                                </Box>
                                <Box>
                                    <FormControl id="document" isRequired isInvalid={ errors.cpf ? true: false  }>
                                        <FormLabel htmlFor='document'>Cpf (somente números)</FormLabel>
                                        <Input
                                            //  ref={firstField}
                                            id='document'
                                            placeholder='Cpf'
                                ...
                                <Box>
                                    <FormControl id="dateBirth" isRequired>
                                        <FormLabel htmlFor='dateBirth'>Data de Nascimento</FormLabel>
                                        <Input
                                        //  ref={firstField}
                                            id='dateBirth'
                                            placeholder='Data'
                                        ...
                                        />
                                        <FormErrorMessage>A data de nascimento é requerida </FormErrorMessage>
                                    </FormControl>
                                </Box>
                                <Box>
                                    <FormControl>
